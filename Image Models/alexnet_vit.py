...
model = AlexNetViT(num_classes=NUM_CLASSES).to(DEVICE)
...
torch.save(model.state_dict(), "alexnet_vit_28class.pth")
print("Model saved to alexnet_vit_28class.pth")
